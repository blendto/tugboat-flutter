...
| Opaque fill `(0x1a,0x1a,0x1a,0xff)` after native mapping | Decode JPEG in the host test | [x] `native_privacy_contract_test.dart` | [ ] PixelCopy JPEG |
...
| Replay acceptance still green | Default Flutter backend | [x] 376 `tugboat` tests | [ ] Android instrumentation |
