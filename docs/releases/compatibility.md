...
| --- | --- | --- |
| Apple `TugboatCaptureRuntime` | 0.1.1 | Rejects transparent and near-white engine-surface results, retries native view-hierarchy capture, and reports the coverage that produced the returned frame. |
