...
import 'package:tugboat_builder/tugboat_builder.dart';
import 'package:test/test.dart';

void main() {
  test('generates a deterministic catalog of public custom widgets', () async {
    final builder = tugboatWidgetCatalogBuilder(BuilderOptions.empty);
    await testBuilder(
      builder,
      {
...
''',
      ...
      outputs: {
        'flutter|lib/tugboat_widgets.g.dart': anything,
        'example|lib/tugboat_widgets.g.dart': decodedMatches(
          allOf(
