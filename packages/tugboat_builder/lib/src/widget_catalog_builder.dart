...
class TugboatWidgetCatalogBuilder extends Builder {
  TugboatWidgetCatalogBuilder({
  ...
  static const defaultOutputPath = 'lib/tugboat_widgets.g.dart';
  static const defaultScanDirectories = ['lib'];
  static const defaultVariableName = 'tugboatWidgetNames';
