...
import 'package:pmkit/src/collector_http_sink.dart';
...
void main() {
  ...
  final collectorConfig = PmkitCollectorConfig(
    ...
    locale: const PmkitCollectorLocaleInfo(language: 'en'),
  );
  ...
  PmkitCollectorConfig configForServer() {
    return PmkitCollectorConfig(
  ...
  PmkitEvent createEvent(int index) {
    return PmkitEvent(
      id: 'event-$index',
      atMs: index,
      type: 'tap',
