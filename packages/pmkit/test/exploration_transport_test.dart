...
import 'package:pmkit/src/exploration_transport.dart';
import 'package:pmkit/src/models.dart';

void main() {
  test('notifies when the exploration collector connects and disconnects', () async {
    final server = await HttpServer.bind(InternetAddress.loopbackIPv4, 0);
    addTearDown(() async => server.close(force: true));

    final connected = Completer<void>();
    final disconnected = Completer<void>();
    final transport = PmkitExplorationTransport(
