...
/// Best-effort HTTP sink for the standalone `pmkit-collector` service.
class CollectorHttpSink implements PmkitCaptureSink {
  CollectorHttpSink({
  ...
  final PmkitCollectorConfig _config;
  ...
  Map<String, String> get _headers => {
    'X-PMKit-API-Key': _config.apiKey,
  ...
  Future<void> _postSessionLifecycle(String eventType, DateTime triggeredAt) async {
    ...
    final body = mapPmkitSessionLifecycleToCollectorSession(
      eventType: eventType,
      sessionId: _collectorSessionId ?? session.id,
  ...
  Future<void> _flushFrames() async {
    ...
    request.headers['X-PMKit-API-Key'] = _config.apiKey;
